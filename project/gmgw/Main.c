...
int main(void)
{
	...
	RS232Off(3);
	// RS232Remap(port232, TX_232, RX_232, RTS_232, CTS_232);
	RS232Remap(3, TX_232, RX_232, 0, 0);
	RS232Init(3, 19200);
	RS232SetParam(3, RS232_STOP_BITS, RS232_ONE_STOP);
	RS232SetParam(3, RS232_DATA_PARITY, RS232_8BITS_PARITY_NONE);
	RS232On(3);

	RS232Write(3, "MAIN APPLICATION ENTRY POINT\r\n");
